...
function M.groups()
  return {
    ...
    -- ["@markup.link"] = { fg = palette.syntax.markup.link, underline = true },
    -- ["@markup.link.label"] = { fg = palette.syntax.markup.link, underline = true },
    -- ["@markup.link.url"] = { fg = palette.syntax.markup.link, underline = true },
    -- ["@markup.raw"] = { fg = palette.syntax.default.foreground },
    ...
    -- ["@markup.link.label.markdown_inline"] = { fg = palette.render.doc.link, italic = true },
    -- ["@markup.link.markdown_inline"] = { fg = palette.render.doc.link, italic = true },
    -- ["@markup.raw.markdown_inline"] = { fg = palette.syntax.default.foreground, bg = palette.render.doc.code_block },
