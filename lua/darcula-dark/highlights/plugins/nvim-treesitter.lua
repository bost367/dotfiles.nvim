...
hi(0, "@type", { fg = palette.lang.default.foreground })
hi(0, "@type.builtin", { fg = palette.lang.default.struct })
hi(0, "@module", { fg = palette.lang.default.foreground })
hi(0, "@module.builtin", { fg = palette.lang.default.foreground })
...
hi(0, "@number.float", { fg = palette.lang.default.number })
hi(0, "@punctuation.delimiter", { fg = palette.lang.default.foreground })
hi(0, "@punctuation.bracket", { fg = palette.lang.default.foreground })
...
hi(0, "@spell.markdown", { fg = palette.lang.default.foreground })
hi(0, "@markup.italic", { fg = palette.lang.default.foreground })
hi(0, "@markup.strikethrough", { fg = palette.lang.default.foreground })
hi(0, "@markup.underline", { fg = palette.lang.default.foreground })
hi(0, "@markup.strong", { fg = palette.lang.default.foreground })
...
hi(0, "@markup.quote", { fg = palette.lang.default.string })
hi(0, "@markup.link", { fg = palette.link })
hi(0, "@markup.link.label", { fg = palette.link })
hi(0, "@markup.link.url", { fg = palette.link })
hi(0, "@markup.raw", { fg = palette.lang.default.string })
hi(0, "@markup.raw.block", { fg = palette.lang.default.string })
...
hi(0, "@punctuation.special", { fg = palette.lang.default.foreground })
hi(0, "@tag", { fg = "#D5B778" })
hi(0, "@tag.attribute", { fg = palette.lang.default.foreground })
hi(0, "@none", { fg = palette.lang.default.foreground })
...
hi(0, "@punctuation.special.yaml", { fg = palette.lang.default.foreground })
...
hi(0, "@keyword.directive.bash", { fg = palette.lang.default.foreground, bold = true })
...
-- XML
hi(0, "@punctuation.delimiter.xml", { fg = palette.lang.default.string })

-- Protobuf
hi(0, "@string.special.proto", { fg = palette.lang.default.string })
