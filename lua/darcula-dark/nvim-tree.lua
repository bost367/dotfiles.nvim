...
hi(0, "NvimTreeModifiedIcon", { fg = palette.file_manager.vcs.changed_file })
...
hi(0, "NvimTreeGitDirtyIcon", { fg = palette.file_manager.vcs.changed_file })
hi(0, "NvimTreeGitIgnoredIcon", { fg = palette.file_manager.vcs.ignored_file })
hi(0, "NvimTreeGitNewIcon", { fg = palette.file_manager.vcs.unknown_file })
hi(0, "NvimTreeGitRenamedIcon", { fg = palette.file_manager.vcs.changed_file })
...
hi(0, "NvimTreeGitFileDirtyHL", { fg = palette.file_manager.vcs.changed_file })
hi(0, "NvimTreeGitFileIgnoredHL", { fg = palette.file_manager.vcs.ignored_file })
hi(0, "NvimTreeGitFileNewHL", { fg = palette.file_manager.vcs.unknown_file })
hi(0, "NvimTreeGitFileRenamedHL", { fg = palette.file_manager.vcs.changed_file })
...
hi(0, "NvimTreeGitFolderDirtyHL", { fg = palette.file_manager.vcs.changed_file })
hi(0, "NvimTreeGitFolderIgnoredHL", { fg = palette.file_manager.vcs.ignored_file })
hi(0, "NvimTreeGitFolderNewHL", { fg = palette.file_manager.vcs.unknown_file })
hi(0, "NvimTreeGitFolderRenamedHL", { fg = palette.file_manager.vcs.changed_file })
