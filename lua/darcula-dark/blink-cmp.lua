...
hi(0, "BlinkCmpScrollBarThumb", { bg = palette.scroll_bar.background })
-- hi(0, "BlinkCmpScrollBarGutter", { bg = "#000000" }) -- find what is it
hi(0, "BlinkCmpLabel", { fg = palette.editor.text })
hi(0, "BlinkCmpLabelDeprecated", { fg = palette.editor.text, strikethrough = true })
-- hi(0, "BlinkCmpLabelMatch", { fg = palette.interface.active_element }) -- unused (doc says)
